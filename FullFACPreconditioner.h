...
private:
     ...
     */
    FullFACPreconditioner(const FullFACPreconditioner& from) = delete;
     ...
     */
    FullFACPreconditioner& operator=(const FullFACPreconditioner& that) = delete;
    ...
    SAMRAI::tbox::Pointer<SAMRAI::solv::SAMRAIVectorReal<NDIM, double>> d_u;
