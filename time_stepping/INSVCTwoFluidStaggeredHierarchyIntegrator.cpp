...
void
INSVCTwoFluidStaggeredHierarchyIntegrator::setInitialData(Pointer<muParserCartGridFunction> un_fcn,
    ...
    */
    ...
    Pointer<VCTwoFluidStaggeredStokesBoxRelaxationFACOperator> fac_precondition_strategy =
        new VCTwoFluidStaggeredStokesBoxRelaxationFACOperator(
            "KrylovPrecondStrategy", "Krylov_precond_", input_db->getDouble("w"), input_db->getDouble("C"));
