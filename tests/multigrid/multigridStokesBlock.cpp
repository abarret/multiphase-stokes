...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        // Results of operator momentum "forces"
        ...
        // TODO: Update the nullspace part below
        ...
        std::vector<Pointer<SAMRAIVectorReal<NDIM, double>>> null_vecs((is_vel_nullspace ? NDIM : 0));
        // if (is_vel_nullspace)
        // {
        //     null_vecs[0] = u_vec.cloneVector("VelNull0");
        //     null_vecs[1] = u_vec.cloneVector("VelNull1");
        //     null_vecs[0]->allocateVectorData();
        //     null_vecs[0]->setToScalar(0.0);
        //     null_vecs[1]->allocateVectorData();
        //     null_vecs[1]->setToScalar(0.0);
        // }
        // // Pull out velocity component and set to constant
        // {
        //     for (int ln = 0; ln <= patch_hierarchy->getFinestLevelNumber(); ++ln)
        //     {
        //         Pointer<PatchLevel<NDIM>> level = patch_hierarchy->getPatchLevel(ln);
        ...
        // Setup velocity and Thn functions.
