...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        out << "Volume fraction\n";
        out << "Thn L1-norm:  " << hier_cc_data_ops.L1Norm(thn_idx, wgt_cc_idx) << "\n";
        out << "Thn L2-norm:  " << hier_cc_data_ops.L2Norm(thn_idx, wgt_cc_idx) << "\n";
        out << "Thn max-norm: " << hier_cc_data_ops.maxNorm(thn_idx, wgt_cc_idx) << "\n";
