...
private:
     ...
     */
    MultiphaseStaggeredStokesVelocitySolve() = delete;
     ...
     */
    MultiphaseStaggeredStokesVelocitySolve(const MultiphaseStaggeredStokesVelocitySolve& from) = delete;
     ...
     */
    MultiphaseStaggeredStokesVelocitySolve& operator=(const MultiphaseStaggeredStokesVelocitySolve& that) = delete;
