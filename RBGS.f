...
c                   Update the even grid cells first, followed by odd grid cells
                    if( MOD(indx+(i1-ilow1)+(i0-ilow0),2).EQ.0 ) then 
c
...
c                   
C                   how do we fill in boundary conditions after the even updates?
                    endif
               enddo
          enddo
     enddo
