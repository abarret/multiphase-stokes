...
MultiphaseStaggeredVelocityBlockFACOperator::MultiphaseStaggeredVelocityBlockFACOperator(
      ...
      d_mask_var(new SideVariable<NDIM, int>(d_object_name + "::mask_var"))
{
    ...
    IBTK_DO_ONCE(t_smooth_error = TimerManager::getManager()->getTimer(
                     "IBTK::MultiphaseStaggeredVelocityBlockFACOperator::smoothError()");
                 t_solve_coarsest_level = TimerManager::getManager()->getTimer(
                     "IBTK::MultiphaseStaggeredVelocityBlockFACOperator::solveCoarsestLevel()");
                 t_compute_residual = TimerManager::getManager()->getTimer(
                     "IBTK::MultiphaseStaggeredVelocityBlockFACOperator::computeResidual()"););
    return;
}

void
MultiphaseStaggeredVelocityBlockFACOperator::setPhysicalBcCoefs(
...
void
MultiphaseStaggeredVelocityBlockFACOperator::restrictResidual(const SAMRAIVectorReal<NDIM, double>& src,
...
void
MultiphaseStaggeredVelocityBlockFACOperator::prolongError(const SAMRAIVectorReal<NDIM, double>& src,
                                                          SAMRAIVectorReal<NDIM, double>& dst,
                                                          const int dst_ln)
{
    // Pull out patch indices.
...
void
MultiphaseStaggeredVelocityBlockFACOperator::prolongErrorAndCorrect(const SAMRAIVectorReal<NDIM, double>& src,
                                                                    SAMRAIVectorReal<NDIM, double>& dst,
                                                                    const int dst_ln)
{
    // Pull out patch indices.
...
void
MultiphaseStaggeredVelocityBlockFACOperator::smoothError(
...
bool
MultiphaseStaggeredVelocityBlockFACOperator::solveCoarsestLevel(SAMRAIVectorReal<NDIM, double>& error,
...
void
MultiphaseStaggeredVelocityBlockFACOperator::computeResidual(SAMRAIVectorReal<NDIM, double>& residual,
...
void
MultiphaseStaggeredVelocityBlockFACOperator::setToZero(SAMRAIVectorReal<NDIM, double>& vec, int level_num)
{
...
void
MultiphaseStaggeredVelocityBlockFACOperator::initializeOperatorState(const SAMRAIVectorReal<NDIM, double>& sol,
                                                                     const SAMRAIVectorReal<NDIM, double>& rhs)
{
...
void
MultiphaseStaggeredVelocityBlockFACOperator::deallocateOperatorState()
{
...
void
MultiphaseStaggeredVelocityBlockFACOperator::setUnderRelaxationParamater(const double w)
{
    d_w = w;
}

void
MultiphaseStaggeredVelocityBlockFACOperator::setCandDCoefficients(const double C, const double D)
{
    d_C = C;
    d_D = D;
}
...
void
MultiphaseStaggeredVelocityBlockFACOperator::performProlongation(const std::array<int, 2>& dst_idxs,
...
void
MultiphaseStaggeredVelocityBlockFACOperator::performRestriction(const std::array<int, 2>& dst_idxs,
                                                                const std::array<int, 2>& src_idxs,
                                                                const int dst_ln)
{
...
void
MultiphaseStaggeredVelocityBlockFACOperator::performGhostFilling(const std::array<int, 2>& dst_idxs, const int dst_ln)
{
    d_un_bc_op->setPatchDataIndex(dst_idxs[0]);
    d_un_bc_op->setHomogeneousBc(true);
