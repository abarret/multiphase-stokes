...
c LU decomposition routines for solving a linear system.        c
c                                                               c
c ----------------------------------------------------          c
c Reference:                                                    c
c                                                               c
c "Numerical Recipes By W.H. Press, B. P. Flannery,             c
c  S.A. Teukolsky and W.T. Vetterling, Cambridge                c
c  University Press, 1986" [BIBLI 08].                          c
c                                                               c 
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
        MODULE LU
        CONTAINS
