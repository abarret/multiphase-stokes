...
IBMultiphaseHierarchyIntegrator::IBMultiphaseHierarchyIntegrator(
    ...
    Pointer<INSVCTwoFluidStaggeredHierarchyIntegrator> ins_hier_integrator,
...
void
IBMultiphaseHierarchyIntegrator::integrateHierarchy(const double current_time,
                                                    const double new_time,
                                                    const int cycle_num)
{
    ...
    Pointer<INSVCTwoFluidStaggeredHierarchyIntegrator> ins_hier_integrator = d_ins_hier_integrator;
                                                               ...
                                                               Pointer<GriddingAlgorithm<NDIM>> gridding_alg)
{
    ...
    d_fn_fcn = new IBMultiphaseEulerianForceFunction(this, false /*solvent force*/);
    d_fs_fcn = new IBMultiphaseEulerianForceFunction(this, true /*solvent force*/);
    ins_integrator->setForcingFunctions(d_fn_fcn, d_fs_fcn, nullptr);
