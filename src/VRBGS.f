...
c
     ...
     &          ((thn_imh_jph-thn(i0,i1)) * dx_dy * un_1(i0,i1+1)
     &          + (thn(i0-1,i1)) * dx_dx * un_0(i0-1,i1)
     &          + (thn(i0,i1) * dx_dx * un_0(i0+1,i1))
     &          + (thn_imh_jph * dy_dy * un_0(i0,i1+1))
     &          + (thn_imh_jmh * dy_dy * un_0(i0,i1-1))
     &          + (thn(i0-1,i1) - thn_imh_jph) * dx_dy
     &                 * un_1(i0-1,i1+1)
     &          + (thn_imh_jmh - thn(i0-1,i1)) * dx_dy
     &                 * un_1(i0-1,i1)
     &          + (thn(i0,i1)-thn_imh_jmh) * dx_dy
     &                 * un_1(i0,i1))
     &          + D * xi * us_0(i0,i1)
     &                 * thn_lower_x * toThs(thn_lower_x))

              un_imhalf_j = un_imhalf_j/ (D * eta_n *
     &          (-(thn(i0,i1) + thn(i0-1,i1)) * dx_dx
     ...
     &          + C * thn_lower_x)
              ...
              us_imhalf_j = f_us_0(i0,i1)
     &         - (D * eta_s * (us_1(i0,i1+1) *
     &          (toThs(thn_imh_jph) - toThs(thn(i0,i1))) * dx_dy
     &          + (toThs(thn(i0-1,i1))) * dx_dx * us_0(i0-1,i1)
     &          + (toThs(thn(i0,i1)) * dx_dx * us_0(i0+1,i1))
     &          + (toThs(thn_imh_jph) * dy_dy * us_0(i0,i1+1))
     &          + (toThs(thn_imh_jmh) * dy_dy * us_0(i0,i1-1))
     &          + (toThs(thn(i0-1,i1))-toThs(thn_imh_jph)) * dx_dy
     &                 * us_1(i0-1,i1+1)
     &          + (toThs(thn_imh_jmh)-toThs(thn(i0-1,i1))) * dx_dy
     &                 * us_1(i0-1,i1)
     &          + (toThs(thn(i0,i1))-toThs(thn_imh_jmh)) * dx_dy
     &                 * us_1(i0,i1))
     &          + D * xi * un_0(i0,i1) * thn_lower_x
     &                 * toThs(thn_lower_x))

              us_imhalf_j = us_imhalf_j/(D * eta_s *
     &          (-(toThs(thn(i0,i1))+toThs(thn(i0-1,i1))) * dx_dx
...
c
     ...
     &           * ((thn_imh_jmh*dx_dx) * un_1(i0-1,i1)
     &           + (thn_iph_jmh*dx_dx) * un_1(i0+1,i1)
     &           + (thn(i0,i1) * dy_dy) * un_1(i0,i1+1)
     &           + (thn(i0,i1-1) * dy_dy) * un_1(i0,i1-1)
     &           + (thn_imh_jmh - thn(i0,i1-1)) * dx_dy
     &                 * un_0(i0,i1-1)
     &           + (thn(i0,i1-1) - thn_iph_jmh) * dx_dy
     &                 * un_0(i0+1,i1-1)
     &           + (thn(i0,i1) - thn_imh_jmh) * dx_dy
     &                 * un_0(i0,i1)
     &           + (thn_iph_jmh - thn(i0,i1)) * dx_dy
     &                 * un_0(i0+1,i1))
     &           + D * xi * us_1(i0,i1)
     &                * thn_lower_y * toThs(thn_lower_y))

              un_i_jmhalf = un_i_jmhalf/ (D * eta_n *
     &           (-(thn(i0,i1) + thn(i0,i1-1)) * dy_dy
     ...
     &           + C * thn_lower_y)
              ...
              ! solve for solvent velocities
              us_i_jmhalf = f_us_1(i0,i1) - (D * eta_s
     &           * ((toThs(thn_imh_jmh) * dx_dx) * us_1(i0-1,i1)
     &           + (toThs(thn_iph_jmh) * dx_dx) * us_1(i0+1,i1)
     &           + (toThs(thn(i0,i1)) * dy_dy) * us_1(i0,i1+1)
     &           + (toThs(thn(i0,i1-1)) * dy_dy) * us_1(i0,i1-1)
     &           + (toThs(thn_imh_jmh) - toThs(thn(i0,i1-1))) * dx_dy
     &                 * us_0(i0,i1-1)
     &           + (toThs(thn(i0,i1-1)) - toThs(thn_iph_jmh)) * dx_dy
     &                 * us_0(i0+1,i1-1)
     &           + (toThs(thn(i0,i1)) - toThs(thn_imh_jmh)) * dx_dy
     &                 * us_0(i0,i1)
     &           + (toThs(thn_iph_jmh) - toThs(thn(i0,i1))) * dx_dy
     &                 * us_0(i0+1,i1))
     &           + D * xi * un_1(i0,i1)
     &                * thn_lower_y * toThs(thn_lower_y))
